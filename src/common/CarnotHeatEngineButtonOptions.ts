/**
 * CarnotHeatEngineButtonOptions.ts
 *
...
export const LIGHT_SURFACE_TEXT_FILL = CarnotHeatEngineColors.controlSurfaceTextColorProperty;

/**
 * Combo-box chrome for panels. Item labels must use {@link LIGHT_SURFACE_TEXT_FILL}, not
 * {@link CarnotHeatEngineColors.textColorProperty} — that color is for labels on the dark panel fill.
 */
export const CARNOT_HEAT_ENGINE_COMBO_BOX_OPTIONS = {
  buttonFill: CarnotHeatEngineColors.controlSurfaceColorProperty,
  listFill: CarnotHeatEngineColors.controlSurfaceColorProperty,
  buttonStroke: CarnotHeatEngineColors.panelBorderColorProperty,
  listStroke: CarnotHeatEngineColors.panelBorderColorProperty,
...
export const TIME_CONTROL_SPEED_RADIO_OPTIONS = {
  speedRadioButtonGroupOptions: {
    labelOptions: { fill: CarnotHeatEngineColors.textColorProperty },
  },
